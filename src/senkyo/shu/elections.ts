...
export interface ShuElection {
    ...
    hireiSeatCounts: { [key in HireiBlockId]: number };
}
...
export const shuElections: readonly ShuElection[] = [
    {
        ...
        hireiSeatCounts: hireiBlockSeatCounts1994,
    },
    {
        number: 42,
        voteDate: '2000-06-25',
        districtCounts: shuDistrictCounts1994,
        hireiSeatCounts: hireiBlockSeatCounts2000,
    },
    {
        number: 43,
        voteDate: '2003-11-09',
        districtCounts: shuDistrictCounts2002,
        hireiSeatCounts: hireiBlockSeatCounts2002,
    },
    {
        number: 44,
        voteDate: '2005-09-11',
    ...
    },
    {
        ...
        hireiSeatCounts: hireiBlockSeatCounts2017,
    },
    {
        number: 49,
        voteDate: '2021-10-31',
    ...
    },
    {
        ...
        hireiSeatCounts: hireiBlockSeatCounts2022,
    },
    {
        number: 51,
        voteDate: '2026-02-08',
